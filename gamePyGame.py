...
if o == 1:
    ...
    if o1 == 1:
        ...
        Play("/audio/souseupai.mp3",False)
        ...
        if o12 == 1:
            ...
            Play("/audio/PegaLadrao.mp3",False)
            print('\033[7mdigite qualquer coisa para continuar\033[m')
            input("")
    ...
    if o2 == 1:
        ...
        if o21 == 1:
            ...
            Play("/audio/mil8.mp3",True)
    else:
        print('\033[7m{} {} esperou\n\033[m'.format(G, nome))
        Play("/audio/1.mp3",False)
        print('\033[7mdigite qualquer coisa para continuar\033[m')
        input("")
        print('\033[7m{} {} esperou!\n\033[m'.format(G, nome))
        Play("/audio/2.mp3",False)
        print('\033[7mdigite qualquer coisa para continuar\033[m')
        input("")
        print('\033[7m{} {} esperou!!!!\n\033[m'.format(G, nome))
        Play("/audio/3.mp3",False)
        print('\033[7mdigite qualquer coisa para continuar\033[m')
        input("")
        print('\033[7m{} {} esperou!!!!!!\n\033[m'.format(G, nome))
        Play("/audio/2000.mp3",False)
        print('\033[7mdigite qualquer coisa para continuar\033[m')
        input("")
